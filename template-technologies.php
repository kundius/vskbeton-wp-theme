          ...
          <div class="equipment">
            ...
            <div class="equipment__content">
              ...
              <div class="equipment__image">
                ...
                <img src="<?php echo $image["url"]; ?>" alt="<?php echo $image[
    "title"
]; ?>">
                <?php endif; ?>
              </div>
    ...
    "title"
          ...
          <div class="documents">
            <div class="documents__cards">
              ...
              <a href="<?php echo $organization_card[
                  "url"
              ]; ?>" class="documents__card documents__card_organization" target="_blank">
                <span class="documents__card-title">Карточка организации</span>
              </a>
              <?php endif; ?>
              <?php if ($evidence = get_field("evidence")): ?>
              <a href="<?php echo $evidence[
                  "url"
              ]; ?>" class="documents__card documents__card_evidence" target="_blank">
              ...
              <a href="<?php echo $certificate[
                  "url"
              ]; ?>" class="documents__card documents__card_certificate" target="_blank">
